 ...
 *  
 * Print Error page and recover cart.
 * 
 * @since 		2016-01-12
 * @modified	
 * @version 	1.0
 ...
 ******************************************************************************************************/
class Magentodesarrollo_Fintonic_Block_Payment_Cancel extends Mage_Payment_Block_Info
{
...
<html lang="en">
  <head>
    ...
    .modal h3 i {
      background-image: url("data:image/png;base64,");
  ...
  <body onload="heightModal()">
    ...
    <div class="window-fixed">
        <div id="modal" class="modal">
            ...
            <h3><i class="icon-error"></i>Lo sentimos</h3>
            <div class="content">
                <div class="column">
                    <p>
                        Lamentablemente tu solicitud de financiación no ha podido ser aprobada.
                    </p>
                    <p>
                        Puedes elegir otros medios de pago para completar tu compra.
                    </p>
                </div>
                <button id="btnSubmit" onclick="canceltFin()" class="btn-submit" type="submit">Seleccionar otra forma de pago</button>
            </div>
        </div>
